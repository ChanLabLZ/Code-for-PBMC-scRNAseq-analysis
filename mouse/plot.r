...
## 2. volcano plot -----------------
library(readxl)
df_plot <- MyReadDelim("./MergeAll.DEG.tissue.2.csv",sep=',')
df_plot_Mertk <- df_plot[df_plot$cellName == "Mertk hi Macro",]
MyWriteTab(df_plot_Mertk, "./MergeAll.DEG.tissue.MertkhiMacro.csv", sep=',')
...
## ------- 3. module score -------
moduleScore <- MyReadDelim("./module_score.csv", sep=',')
